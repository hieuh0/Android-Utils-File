...
public class LabeledSwitch extends ToggleableView {
    ...
    private void initView() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
            colorBorder = getResources().getColor(android.R.color.transparent, getContext().getTheme());
            colorOn = getResources().getColor(R.color.white);
        } else {
            colorBorder = getResources().getColor(android.R.color.transparent);
            colorOn = getResources().getColor(R.color.white);
        }
...
//      Drawing Switch background here
        {
            ...
            if(isEnabled()) {
                onColor = getResources().getColor(android.R.color.transparent);
            } else {
